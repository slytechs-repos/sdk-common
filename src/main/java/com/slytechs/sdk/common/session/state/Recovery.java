 ...
 * 
 * <p>
 * Implement this interface with an enum to define custom recovery actions for
 * specific state machines. Each recovery action specifies whether it is
 * terminal, whether to restart, and any delay before restart.
 * </p>
 * 
