...
import com.slytechs.sdk.common.session.state.ServiceStateMachine;
 ...
 */
public interface ServiceSession extends Session, Shutdownable {
	Duration DEFAULT_TIMEOUT = SystemSession.DEFAULT_TIMEOUT;
