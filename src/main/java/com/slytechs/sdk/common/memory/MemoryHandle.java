...
public abstract class MemoryHandle<T> {
    ...
    public static class BooleanHandle extends MemoryHandle<Boolean> {
        ...
        public BooleanHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public BooleanHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public BooleanHandle(VarHandle handle) { super(handle); }
    ...
    public static class ByteHandle extends MemoryHandle<Byte> {
        ...
        public ByteHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public ByteHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public ByteHandle(VarHandle handle) { super(handle); }
    ...
    public static class CharHandle extends MemoryHandle<Character> {
        ...
        public CharHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public CharHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public CharHandle(VarHandle handle) { super(handle); }
    ...
    public static class DoubleHandle extends MemoryHandle<Double> {
        ...
        public DoubleHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public DoubleHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public DoubleHandle(VarHandle handle) { super(handle); }
    ...
    public static class FloatHandle extends MemoryHandle<Float> {
        ...
        public FloatHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public FloatHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public FloatHandle(VarHandle handle) { super(handle); }
    ...
    public static class IntHandle extends MemoryHandle<Integer> {
        ...
        public IntHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public IntHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public IntHandle(VarHandle handle) { super(handle); }
    ...
    public static class LongHandle extends MemoryHandle<Long> {
        ...
        public LongHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public LongHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public LongHandle(VarHandle handle) { super(handle); }
    ...
    public static class ShortHandle extends MemoryHandle<Short> {
        ...
        public ShortHandle(MemoryLayout layout, PathElement... path) { super(layout, path); }
        public ShortHandle(MemoryLayout layout, String... path) { super(layout, path); }
        public ShortHandle(VarHandle handle) { super(handle); }
