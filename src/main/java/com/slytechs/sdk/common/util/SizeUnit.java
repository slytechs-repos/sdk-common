 ...
 */
public enum SizeUnit implements ConvertableUnit<SizeUnit>, Unit {

	/** Represents bits. */
	BITS("bit") {
		@Override
		public long convert(long size, SizeUnit sourceUnit) {
	...
	public static String format(String fmt, long inBytes) {
		return UnitUtils.format(fmt, inBytes, SizeUnit.class, BYTES);
	}
	/**
	 ...
	 */
	public static SizeUnit nearest(long inBytes) {
		return UnitUtils.nearest(inBytes, SizeUnit.class, BYTES);
	}
	...
	public double convertf(double inBytes) {
		return convertf(inBytes, SizeUnit.BYTES);
	}
	 ...
	 */
	@Override
	public double convertf(double size, SizeUnit sourceUnit) {
