...
import com.slytechs.sdk.common.util.function.Tuple.Tuple2.Tuple2Record;
import com.slytechs.sdk.common.util.function.Tuple.Tuple3.Tuple3Record;
import com.slytechs.sdk.common.util.function.Tuple.Tuple4.Tuple4Record;
import com.slytechs.sdk.common.util.function.Tuple.Tuple5.Tuple5Record;
...
public interface Tuple {
	...
	interface Tuple2<T1, T2> extends Tuple {
		...
		record Tuple2Record<T1, T2>(int size, T1 value1, T2 value2) implements Tuple2<T1, T2> {
			...
			/**
			 * @see com.slytechs.sdk.common.util.function.Tuple#values()
			 */
			@Override
