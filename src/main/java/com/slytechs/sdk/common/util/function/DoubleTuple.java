...
public interface DoubleTuple {
	...
	interface DoubleTuple2 extends DoubleTuple {
		...
		/**
		 * @see com.slytechs.sdk.common.util.function.DoubleTuple#size()
		 */
		@Override
		default int size() {
			return 2;
	...
	interface DoubleTuple3 extends DoubleTuple {
		...
		/**
		 * @see com.slytechs.sdk.common.util.function.DoubleTuple#value3()
		 */
		@Override
		double value3();
	}
	...
	interface DoubleTuple4 extends DoubleTuple {
		...
		/**
		 * @see com.slytechs.sdk.common.util.function.DoubleTuple#value4()
		 */
		@Override
		double value4();
	}
	...
	interface DoubleTuple5 extends DoubleTuple {
		...
		/**
		 * @see com.slytechs.sdk.common.util.function.DoubleTuple#value5()
		 */
		@Override
		double value5();
	}
	...
	record Tuple2d(double value1, double value2) implements DoubleTuple2 {
		...
		/**
		 * @see com.slytechs.sdk.common.util.function.DoubleTuple#values()
		 */
		@Override
