 ...
 * <ul>
 * <li><strong>Immutable segment:</strong> The memory segment is final and set at construction</li>
 * <li><strong>Pool-managed:</strong> Typically allocated from and returned to memory pools</li>
 * <li><strong>Chainable:</strong> Supports linking multiple segments for scatter-gather</li>
 * <li><strong>Reusable:</strong> Can be recycled and reused without reallocation</li>
 * </ul>
 * 
...
public class FixedMemory extends AbstractMemory {
    ...
    /** The owning pool (optional) */
    protected MemoryPool<FixedMemory> pool;

    /**
     * Constructs a FixedMemory with the given segment.
     * 
     * <p>
     * The entire segment becomes the active data region. Use
     * {@link #start(long)} and {@link #end(long)} to adjust the
     * active boundaries after construction.
     * </p>
     * 
     ...
     * 
     * <p>
     * Creates a fixed memory with specific offset and length within
     * the provided segment. The active data region initially encompasses
     ...
     * 
     * <p>
     * Used by memory pools to create instances that will automatically
     * return to the pool when their reference count reaches zero.
     * </p>
     * 
     ...
     * 
     * <p>
     * Returns the immutable segment associated with this fixed memory.
     * The segment remains valid for the lifetime of this object.
     * </p>
     */
    @Override
    ...
    /**
     * Sets the owning pool for this memory.
     * 
     * <p>
     * Called by pools after construction to establish ownership.
     * When reference count reaches zero, the memory automatically
     * returns to this pool.
     * </p>
     * 
     * @param pool the owning pool
     */
    void setPool(MemoryPool<FixedMemory> pool) {
        this.pool = pool;
    }
     ...
     */
    public MemoryPool<FixedMemory> getPool() {
        return pool;
    }
     ...
     * 
     * <p>
     * Resets the memory for reuse by restoring data boundaries to
     * the full segment bounds and clearing chain references.
     * </p>
     */
    @Override
    public void recycle() {
     ...
     * pool-managed, it automatically returns to the pool. Otherwise,
     * it simply clears chain references.
     * </p>
     */
    @Override
