 ...
 * 
 * <p>
 * MemoryBuffer extends MemoryBufferView to provide all data access operations,
 ...
 * <pre>{@code
* java.nio:           Our Design:
* Buffer              MemoryBufferView        (control layer)
*     ↓                    ↓
* MemoryBufferView    MemoryBuffer    (accessor layer - THIS CLASS)
* }</pre>
 * 
 * <h2>Key Features</h2>
 * <ul>
 ...
 * @since 1.0
 */
public class MemoryBuffer extends MemoryBufferView {
	 ...
	 */
	public MemoryBuffer(MemoryPool<MemoryBuffer> owningPool,
	 ...
	 * @param memorySegment the backing memory segment
	 */
	public MemoryBuffer(MemorySegment memorySegment) {
	 ...
	 * @param memoryEnd     ending offset within segment (exclusive)
	 */
	public MemoryBuffer(MemorySegment memorySegment, long memoryOffset, long memoryEnd) {
	 ...
	 */
	private void allocateGapAndOverflow(long gapRemaining, MemoryBuffer prevSegment) {
		if (gapRemaining <= 0)
			return;

		MemoryPool<MemoryBuffer> pool = (MemoryPool<MemoryBuffer>) getOwningPool();
		MemoryBuffer newSegment = pool.allocate();
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer get(long index, byte[] dst) {
		if (checkError())
			return this;
		if (dst == null) {
			setError(new BufferOperationException("Destination array is null"));
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer get(long index, byte[] dst, int offset, int length) {
		if (checkError())
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer insertSpace(long size) {
		if (checkError())
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer put(long index, byte[] src) {
		if (checkError())
			return this;
		if (src == null) {
			setError(new BufferOperationException("Source array is null"));
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer put(long index, byte[] src, int offset, int length) {
		if (checkError())
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBuffer removeSpace(long size) {
		if (checkError())
			return this;
