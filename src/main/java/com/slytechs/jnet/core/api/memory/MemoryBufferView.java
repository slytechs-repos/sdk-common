 ...
 * 
 * <p>
 * MemoryBufferView provides the control infrastructure for buffer-style
 * operations, following the java.nio.Buffer pattern. This abstract class
 * manages buffer state (position, limit, mark), error accumulation, and
 * multi-segment chain navigation. Concrete subclasses like MemoryBuffer build
 * upon this foundation to provide data access operations.
 * </p>
 * 
 ...
 * <pre>{@code
 * java.nio:           Our Design:
 * Buffer              MemoryBufferView        (control layer - THIS CLASS)
 *   ↓                   ↓
 * ByteBuffer          MemoryBuffer    (accessor layer)
 * }</pre>
 * 
 * <h2>Key Features</h2>
 * <ul>
 ...
 * @since 1.0
 */
public abstract class MemoryBufferView extends AbstractMemory implements MemoryPoolable {
	...
	/** The owning pool. */
	private final MemoryPool<? extends MemoryBufferView> owningPool;
	 ...
	 */
	protected MemoryBufferView(MemoryPool<? extends MemoryBufferView> owningPool) {
	...
	/**
	 * Constructs a MemoryBufferView with specified bounds.
	 *
	 * @param owningPool       the owning pool
	 ...
	 */
	public MemoryBufferView adjustPosition(long delta) {
		if (hasError)
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView backup(long bytes) {
		if (hasError)
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView chainPosition(long chainOffset) {
		if (hasError)
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView clearError() {
		this.hasError = false;
		this.pendingError = null;
		return this;
	}
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView compact() {
		if (hasError)
			return this; // No-op in error state
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView ensureRemaining(long required) {
		if (hasError)
			return this;
	 ...
	 */
	@Override
	public MemoryPool<? extends MemoryBufferView> getOwningPool() {
		return owningPool;
	}
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView ifError(Consumer<BufferOperationException> errorConsumer) {
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView limit(long newLimit) {
		if (hasError)
			return this;
	...
	public <T extends MemoryBufferView> T onError(BufferErrorHandler<T> handler) {
		if (handler == null) {
	 ...
	 */
	public MemoryBufferView orElseThrow() throws BufferOperationException {
		if (hasError && pendingError != null) {
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView position(long newPosition) {
		if (hasError)
			return this;
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView positionAt(MemoryProxy proxy) {
		if (hasError)
			return this;
	...
	private void returnToPool() {
		...
		// Return to pool
		@SuppressWarnings("unchecked")
		MemoryPool<MemoryBufferView> pool = (MemoryPool<MemoryBufferView>) owningPool;
		pool.release(this);
	}
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView rewind() {
		if (hasError)
			return this; // No-op in error state
	 ...
	 * @return this buffer for method chaining
	 */
	public MemoryBufferView skip(long bytes) {
		if (hasError)
			return this;
	...
	public String toString() {
		...
		if (!hasError)
			return String.format("MemoryBufferView[pos=%d, lim=%d, cap=%d, ref=%d, chain=%s]",
					position, limit, totalActiveBytesRaw(), refCount(),
					toStringChain());
		else
			return String.format("MemoryBufferView[pos=%d, lim=%d, cap=%d, ref=%d, err=%s, chain=%s]",
	...
	public String toStringChain() {
		...
		while (mb != null) {
			...
			mb = (MemoryBufferView) mb.nextSegmentRaw();
		}
